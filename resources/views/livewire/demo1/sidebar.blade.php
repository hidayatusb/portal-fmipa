        ...
        <div class="kt-scrollable-y-hover grow shrink-0 flex ps-2 lg:ps-5 pe-1 lg:pe-3" data-kt-scrollable="true"
            ...
            <div class="kt-menu flex grow flex-col gap-1" data-kt-menu="true" data-kt-menu-accordion-expand-all="false"
                ...
                @if ($user?->isDosen())
                    ...
                    <div class="kt-menu-item">
                        <a class="kt-menu-link kt-menu-item-active:bg-accent/60 dark:menu-item-active:border-border kt-menu-item-active:rounded-lg hover:bg-accent/60 grow items-center gap-[10px] border border-transparent py-[6px] pe-[10px] ps-[10px] hover:rounded-lg {{ request()->routeIs('dosen.bimbingan-skripsi.*') ? 'kt-menu-item-active' : '' }}"
                            href="{{ route('dosen.bimbingan-skripsi.index') }}" wire:navigate tabindex="0">
                            <span class="kt-menu-icon w-[20px] items-start text-muted-foreground">
                ...
                @if ($user?->isMahasiswa())
                    ...
                    <div class="kt-menu-item">
                        <a class="kt-menu-link kt-menu-item-active:bg-accent/60 dark:menu-item-active:border-border kt-menu-item-active:rounded-lg hover:bg-accent/60 grow items-center gap-[10px] border border-transparent py-[6px] pe-[10px] ps-[10px] hover:rounded-lg {{ request()->routeIs('mahasiswa.bimbingan-skripsi.*') ? 'kt-menu-item-active' : '' }}"
                            href="{{ route('mahasiswa.bimbingan-skripsi.index') }}" wire:navigate tabindex="0">
                            <span class="kt-menu-icon w-[20px] items-start text-muted-foreground">
                                <i class="ki-filled ki-teacher text-lg"></i>
                            </span>
                            <span
